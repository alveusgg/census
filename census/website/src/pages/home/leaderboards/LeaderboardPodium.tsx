...
export const LeaderboardPodium: FC<{ leaderboard: LeaderboardPodiumEntry[] }> = ({ leaderboard }) => {
    ...
    <div className="grid h-32 w-full grid-cols-3 items-end gap-2.5">
      {second && (
        <Podium
          transition={{ delay: 1 }}
          badge={
            <Badge className="absolute left-1/2 -top-6 -translate-x-1/2" variant="silver" transition={{ delay: 1.25 }}>
              {places.second}
            </Badge>
          }
        >
          <UserLink user={second} className="block truncate font-sans text-base font-bold leading-tight text-white" />
      ...
      {first && (
        <Podium
          badge={
            <Badge className="absolute left-1/2 -top-8 -translate-x-1/2" variant="gold" transition={{ delay: 0.25 }}>
              {places.first}
            </Badge>
          }
        >
          <UserLink user={first} className="block truncate font-sans text-base font-bold leading-tight text-white" />
      ...
      {third && (
        <Podium
          transition={{ delay: 2 }}
          badge={
            <Badge className="absolute left-1/2 -top-6 -translate-x-1/2" variant="bronze" transition={{ delay: 2.25 }}>
              {places.third}
            </Badge>
          }
        >
          <UserLink user={third} className="block truncate font-sans text-base font-bold leading-tight text-white" />
    ...
    <svg width={34} className="z-10" viewBox="0 0 92.12 125">
      <defs>
        <linearGradient id="linear-gradient" x1="46.06" y1="2.33" x2="46.06" y2="123.49" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#e6b433" />
          <stop offset=".32" stopColor="#ecc354" />
          <stop offset=".41" stopColor="#fff6c5" />
          <stop offset=".48" stopColor="#ffeb7e" />
          <stop offset=".8" stopColor="#e8b83c" />
          <stop offset="1" stopColor="#ffe96d" />
        </linearGradient>
      </defs>
      <path

    ...
    <div className={cn('relative w-fit', className)} {...props}>
      ...
      <div className="w-full absolute inset-0 pointer-events-none">
        <motion.div
          layoutScroll
          className={cn(
            'text-white min-w-12 mx-auto relative bg-leaderboard-400 w-fit px-3 py-1 rounded-full font-bold flex justify-center items-center dark:border dark:border-leaderboard-300 dark:bg-leaderboard-700 dark:text-leaderboard-50',

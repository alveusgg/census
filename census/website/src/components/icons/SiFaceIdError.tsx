...
const SiFaceIdError = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    />
    <path
      d="M8.75 15.25C8.75 15.25 9 13.75 12 13.75C15 13.75 15.25 15.25 15.25 15.25"
      stroke="currentColor"
      strokeWidth={2}
      strokeLinecap="round"
      strokeLinejoin="round"

...
const SiMicrophoneMute = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" fill="none" viewBox="0 0 24 24" {...props}>
    ...
    />
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 17.75V19.25" />
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export default SiMicrophoneMute;

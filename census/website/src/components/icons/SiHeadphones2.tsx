...
const SiHeadphones2 = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
      d="M14.75 19.25V17.25H16.25C17.9069 17.25 19.25 15.9069 19.25 14.25V11C19.25 6.99594 16.0041 4.75 12 4.75C7.99594 4.75 4.74986 7 4.75 11C4.75014 15 4.95 17 7.75 17V19.25"
      stroke="currentColor"
      strokeWidth={2}
      strokeLinecap="round"

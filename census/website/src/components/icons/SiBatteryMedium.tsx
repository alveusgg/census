...
const SiBatteryMedium = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" fill="none" viewBox="0 0 24 24" {...props}>
    ...
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.25 9.75V14.25" />
    <path
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export default SiBatteryMedium;

// Generated by Wrangler by running `wrangler types` (hash: 6e2584282ac9ba559ba75a1061fe99f3)
// Runtime types generated with workerd@1.20250320.0 2024-07-01 
declare namespace Cloudflare {
	interface Env {
		API_BASE_URL: string;
		WORKER_API_TOKEN: string;
		TLDRAW_DURABLE_OBJECT: DurableObjectNamespace<import("./worker").TldrawDurableObject>;
	}
}
